        ...
        <form action="{{url('/post_create_campaign')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 mb-5">
                    <div class="row">
                        <label class="col-sm-2  text-sm-end text-end" for="formtabs-first-name">Campaign Name</label>
                        <div class="col-sm-8">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 mb-5">
                    <div class="row">
                        <label class="col-sm-2  text-sm-end text-end" for="formtabs-first-name">Webinars</label>
                        <div class="col-sm-5">
                            <input type="text" id="formtabs-first-name" class="form-control" placeholder="Enter Name" />
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 mb-5">
                    <div class="row">
                        <label class="col-sm-2  text-sm-end text-end" for="formtabs-first-name">Subject</label>
                        <div class="col-sm-4">
                            <input type="text" id="formtabs-first-name" class="form-control" placeholder="Enter Name" />
                        </div>

                        <div class="col-sm-4"><select id="formtabs-country" class="select2 form-select">
                                <option value="">Personalize</option>
                                <option value="Australia">Contact First Name</option>
                                <option value="United Arab Emirates">Contact Last Name</option>
                            </select>
