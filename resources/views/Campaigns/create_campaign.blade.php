...
<div class="content-wrapper">
    ...
    <h6>Campaigns> Email Campaings</h6><br>
        ...
        <div class="d-flex justify-content-between">
            <!-- flex child-1 -->
            <div class="ms-3 mb-5 fw-light text-secondary" style="margin-left: 500px!important; font-size: 1.5rem;">What type of Campaign would you like to create?
            </div>
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                ...
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver1()" onmouseleave="mouseLeave1()" data-bs-toggle="modal" data-bs-target="#filtering1">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver2()" onmouseleave="mouseLeave2()" data-bs-toggle="modal" data-bs-target="#filtering2">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver3()" onmouseleave="mouseLeave3()" data-bs-toggle="modal" data-bs-target="#filtering3">
                    <div class="card-body">
                    ...
                    <div>
                        <a class="btn btn-warning mb-4 d-none" id="create_new3" style="width: 150px!important; margin: 0 auto; border-radius: 1.5rem;" href="{{url('/rss')}}">Create New</a>
                    </div>
                </div>
            </div>

            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver4()" onmouseleave="mouseLeave4()" data-bs-toggle="modal" data-bs-target="#filtering4">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver5()" onmouseleave="mouseLeave5()" data-bs-toggle="modal" data-bs-target="#filtering5">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver6()" onmouseleave="mouseLeave6()" data-bs-toggle="modal" data-bs-target="#filtering6">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver7()" onmouseleave="mouseLeave7()" data-bs-toggle="modal" data-bs-target="#filtering7">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver8()" onmouseleave="mouseLeave8()" data-bs-toggle="modal" data-bs-target="#filtering8">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver9()" onmouseleave="mouseLeave9()" data-bs-toggle="modal" data-bs-target="#filtering9">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver10()" onmouseleave="mouseLeave10()" data-bs-toggle="modal" data-bs-target="#filtering10">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver11()" onmouseleave="mouseLeave11()" data-bs-toggle="modal" data-bs-target="#filtering11">
                    <div class="card-body">
            ...
            <div class="col-md-3 col-lg-3 mb-5 all_campaign">
                <div class="card h-100 text-center" style="border-radius: 1.5rem!important" class="all_campaign" onmouseover="mouseOver12()" onmouseleave="mouseLeave12()" data-bs-toggle="modal" data-bs-target="#filtering12">
                    <div class="card-body">
