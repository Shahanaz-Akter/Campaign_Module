...
@section('title')
<title>Zoho Form Regular Campaigns</title>
@endsection
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{url('/post_create_campaign')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3 mt-5">
                ...
                <div class="col-sm-12 col-md-11 col-lg-10 mb-5">
                    <div class="row">
                        <label class="col-sm-2 col-md-2 col-lg-2 text-sm-end text-md-end text-lg-end" for="zoho_forms">Zoho Forms</label>
                        <div class="col-sm-10 col-md-9 col-lg-8">
                            <select class="select2 form-select">
                                <option value="">Choose forms</option>
                                <option value="">form_template1</option>
                                <option value="">form_template2</option>
                                <option value="">form_template3</option>
                            </select>
                        </div>
