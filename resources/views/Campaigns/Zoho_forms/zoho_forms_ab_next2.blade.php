    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{url('/post_create_campaign')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12 mb-3">
                    <div class="row">
                        <label class="col-sm-2  text-sm-end" for="formtabs-first-name">Zoho Forms</label>
                ...
                <div class="col-12 mb-5">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input id="single_address" style="margin-left: -50px;" name="all" type="radio" value="single_address" />
                            <label class="ms-1" for="single_address">Single Address</label>
                ...
                <div class="d-none mimi">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="row">
                            <label class="col-sm-2 text-sm-end text-lg-end  text-md-end text-xxl-end" for="formtabs-first-name">Reply-To</label>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 mb-5">
                        <div class="row">
                            <label class="col-sm-2 text-sm-end text-lg-end  text-md-end text-xxl-end" for="formtabs-first-name">Alter nate-Reply-To-address</label>
        ...
        <div class="d-flex justify-content-end">
            ...
            <!-- flex child-1 -->
            <a href="{{url('/zoho_ab_testing_campaign')}}">
            ...
            <!-- flex child-2 -->
            <a href="{{url('/zoho_forms_ab_next2')}}">
