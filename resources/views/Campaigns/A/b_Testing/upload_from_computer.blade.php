    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{url('/post_upload_Computer')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex  justify-content-center align-items-center gap-3 mb-5">
                ...
                <!-- child 2 -->
                <div class="card text-center text-black h_effect" style="max-width: 50%;">
                    <!-- Multi  -->
                    <!-- <h5 class="card-header">Multiple</h5> -->
                    <div class="card-body" style="color: black!important">
                        <form action="https://pixinvent.com/upload" class="dropzone needsclick" id="dropzone-multi">
                            <div class="dz-message needsclick">
                                Drop files here or click to upload
                                <span class="note needsclick text-black">(This is just a Uploading dropzone.You can select Multiple files)</span>
                            </div>
                            <div class="fallback">
                                <input name="file" type="file" />
                            </div>
