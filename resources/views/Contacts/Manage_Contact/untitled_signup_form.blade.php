...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed " dir="ltr" data-theme="theme-semi-dark" data-assets-path="/assets/" data-template="vertical-menu-template-semi-dark">
  ...
  <head>
    ...
    <title>Untitled Signup Form</title>
...
<body>
                ...
                <div class="content-wrap1er">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="bg-white p-3">
                            <div>
                                <div>
                                    <a href="{{url('/add_user')}}"><i class="ms-5 fa-solid fa-arrow-left"></i>
                                        <div type="button" class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    </a> My Sample
                                </div>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="">Marketing Contacts</a></li>
                                    <li><a class="dropdown-item" href="">Added in Last 10days</a></li>
                                    <li><a class="dropdown-item" href="">Added in Last 30days</a></li>
                                    <li><a class="dropdown-item" href="">Non Marketing Contacts</a></li>
                                    <li><a class="dropdown-item" href="">All Contacts</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="">No list Available</a></li>
                                </ul>
                            </div>

                            <div class="d-flex justify-content-between">

                                <div class="d-flex justify-content-start gap-5 ms-5 p-3">
                                    <div class="text-center text-black">
                                        <div class="text-primary compact" onclick="list_summary()">List Summary</div>
                                    </div>

                                    <div class="text-center text-black">
                                        <div class="">
                                            <div class="text-primary compact" onclick="contact()">Contact</div>
                                        </div>
                                    </div>

                                    <div class="text-center text-black">
                                        <div class="">
                                            <div class="text-primary compact" onclick="form()">Forms</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center text-black">
                                        ...
                                        <div class="">
                                            <div class="text-primary compact" onclick="setup()">setup</div>
                                        </div>
                                    </div>
                                </div>

                                <div class="">
                                    <button class="btn btn-primary">Contact view</button>
                                    <button class="btn btn-primary ms-1">Response view</button>


                                    <div type="button" class="btn btn-danger ms-1 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        Add
                                    </div>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="">Add Contacts</a></li>
                                        <li><a class="dropdown-item" href="">Signup Form</a></li>
                                        <li><a class="dropdown-item" href="">Regular Campaign</a></li>
                                        <li><a class="dropdown-item" href="">Advanced Campaign</a></li>
                                        <li><a class="dropdown-item" href="">Autoresponder</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item" href="">No list Available</a></li>
                                    ...
                                    <div type="button" class="btn btn-outline-danger ms-1 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        More
                                    </div>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="">Edit list</a></li>
                                        <li><a class="dropdown-item" href="">Assign Topics</a></li>
                                        <li><a class="dropdown-item" href="">Mass Update</a></li>
                                        <li><a class="dropdown-item" href="">Export Contacts</a></li>
                                        <li><a class="dropdown-item" href="">Import Over view</a></li>
                                        <li><a class="dropdown-item" href="">Campaign Archieve</a></li>
                                        <li><a class="dropdown-item" href="">Clear List</a></li>
                                        <li><a class="dropdown-item" href="">Delete List</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item" href="">No list Available</a></li>
                            ...
                            <div class="container-sm container-md container-lg container-xxl">
                                ...
                                <div class="contact">
                                    <div class="d-flex justify-content-start gap-2 mt-3">
                                        ...
                                        <div class="p-2 btn-group">
                                            <div type="button" class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="fa-solid fa-tag me-3"></i>All Contacts
                                            </div>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="">Marketing Contacts</a></li>
                                                <li><a class="dropdown-item" href="">Added in Last 10days</a></li>
                                ...
                                <div class="d-none list_summary">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim suscipit alias doloribus similique iure iste a nihil adipisci incidunt obcaecati iusto laudantium repellat ipsam voluptates repellendus quidem, sunt sed ut provident. Voluptates, accusantium eligendi sed quos possimus consequuntur sequi non vitae quisquam doloremque eum inventore hic iure quia praesentium? Ducimus nulla praesentium, non ullam in aperiam nostrum. Repudiandae magni unde magnam doloribus! Cumque fuga facere reprehenderit! Tempore voluptate aliquid soluta ipsa cum ducimus nobis nemo quasi earum, laudantium voluptas vel, molestias rem eaque doloribus facilis similique illum totam fuga, distinctio consectetur consequuntur. Inventore rerum accusantium neque, culpa error ipsum ad.</p>
                                </div>
    ...
    <script>
        const list_summary = () => {
            ...
            let list_summary = document.querySelector('.list_summary');
            let list_summary_tr = list_summary.classList.contains('d-none');
            ...
            if (list_summary_tr) {
                list_summary.classList.remove('d-none');
        ...
        const contact = () => {
            let list_summary = document.querySelector('.list_summary');
            let contact = document.querySelector('.contact');
            let contact_tr = contact.classList.contains('d-none');
            ...
            if (contact_tr) {
                ...
                form.classList.add('d-none');
                list_summary.classList.add('d-none');
                setup.classList.add('d-none');
            }
        }
        ...
        const form = () => {
            ...
            let contact = document.querySelector('.contact');
            let form = document.querySelector('.form');
            let form_tr = form.classList.contains('d-none');
        ...
        const setup = () => {
            ...
            let setup = document.querySelector('.setup');
            console.log(setup);
            let setup_tr = setup.classList.contains('d-none');
