        ...
        <form action="" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-12 col-lg-7 col-xxl-7">
                    <input type="text" class="form-control border-2 border-primary ms-3" placeholder="Name" />
                </div>
            </div>
            ...
            <!-- Form Repeater -->
            <div class="row mb-3">
                <label class="col-sm-2 col-lg-2 col-xxl-2 text-sm-end mt-4" for="" style="font-weight:500;">Criteria</label>
                <div class="col-sm-12 col-lg-9 col-xxl-9 form-repeater ">

                    <!-- <div class="row add_pa">
                        <section class="add_ch"> -->
                    <!-- Form Repeater -->
                    <div class="col-md-10 mb-4 mt-2 ms-2 row">
                        <!-- <label class="col-sm-2" for="" style=""></label> -->
            ...
            <div class="pt-4 d-flex justify-content-center ms-5 me-5">
                Tip: Comma-separated search values can be given. They will be interpreted as 'OR' criteria. Ex: "Last Name contains Jones, West" will be treated as (Last Name contains Jones) OR (Last Name contains West).
                Example Last Name contains Jones, Smith, West will be treated as (Last Name contains Jones) OR (Last Name contains Smith) OR (Last Name contains West).
            </div>
