        ...
        <div class="d-flex justify-content-between mb-3 mt-5">
            <div>
                ...
                <div class="d-flex justify-content-between mb-5">
                    <input class="form-control" type="text" placeholder="Untitled Signup Form" value="Untitled Signup Form" style="border: 1px solid red;">
                    <span><i class="fas fa-check  ms-3 me-2 text-success" style="font-size: 30px;"></i></span>
                    <span><i class="fas fa-times ms-2 text-danger" style="font-size: 30px;"></i></span>
                </div>
